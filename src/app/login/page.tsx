  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {error && (
          <div style={{
            padding: "12px 16px", background: "#EF444415", borderRadius: 8,
            borderLeft: "3px solid #EF4444", marginBottom: 20, textAlign: "left",
          }}>
            <p style={{ margin: 0, fontSize: 12, color: "#EF4444", fontWeight: 600 }}>
              {error === "AccessDenied"
                ? "Acceso denegado — solo cuentas @focux.co autorizadas."
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.borderColor = "#0D7AB5"; e.currentTarget.style.boxShadow = "0 4px 20px #0D7AB530"; }}
          onMouseLeave={e => { e.currentTarget.style.borderColor = "#2A2F4A"; e.currentTarget.style.boxShadow = "none"; }}
        >
